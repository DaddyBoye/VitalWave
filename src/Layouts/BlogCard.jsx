  ...
  return (
    <div className="w-full lg:w-72 overflow-hidden rounded-lg bg-white shadow-md hover:shadow-xl transition-all duration-300">
      ...
      <div className="p-4 space-y-3">
        ...
        <button className="w-full bg-backgroundColor text-white py-2 px-4 rounded-lg hover:bg-white hover:text-backgroundColor transition-colors duration-300 text-sm font-medium">
          Read More
        </button>
      </div>
    </div>
